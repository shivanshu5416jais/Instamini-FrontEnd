...
class Comment extends Component {
    ...
    isValid=()=>{
        ...
        if(text.length==0||text.length>150){
            this.setState({error:"Comment should not be empty and must be less than 150 characters long"});
        return false
        }
        return true
    }
    ...
    addComment=e=>{
        ...
        .then(data=>{
            if(data.error){
                ...
                this.setState({text:''})
                // dispatch fresh list of comment to parent component (singlepost)
                           ...
                           (<div key={i}>
                                   ...
                                   <div>
                                       <Link to={`/user/${comment.postedBy._id}`}>
                                           ...
                                           className="float-left mr-2" height="30px"
                                           width="30px"
                                        ...
                                        <div>
                                               ...
                                               Posted by <Link to={`/user/${comment.postedBy._id}`}>
